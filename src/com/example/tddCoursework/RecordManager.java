...
public class RecordManager {
  ...
  public ArrayList<Student> getStudentsByName(String search) {
    ...
    if (searchResult.size() == 0)
      throw new IllegalArgumentException("No Student with that name found");
    return searchResult;
  }
   ...
   * @see Student
   */
  public void setStudentAddModule(UUID id, String code, String title, Integer mark) {
   ...
   * @see Student
   */
  public void setStudentAddModule(UUID id, String code, String title) {
