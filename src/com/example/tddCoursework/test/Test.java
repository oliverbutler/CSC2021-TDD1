...
public class Test {
  public static void main(String[] args) {
    Student oliver = new Student("Oliver Butler", "oliver@oliverbutler.uk", "Laurel Cottage", "Computer Science",
        LocalDate.of(2018, 9, 20));
    oliver.addModule(new Module("CSC2023", "Algorithms"));
    oliver.addModule(new Module("CSC2021", "Software Engineering", 69));

    Student jack = new Student("Jack Tweddell", "email@jack.com", "Durham", "Computer Science",
